...
def get_table_csv_results(file_name):
    ...
    with open('comparison-input-data/{}'.format(file_name), "rb") as file:
        img_test = file.read()
...
def main(file_name):
    ...
    output_file = "comparison-output-data/textract/{}.csv".format(file_name[:-4])
...
if __name__ == "__main__":
    for file in ['scan1.pdf','scan2_page1.pdf', 'scan2_page2.pdf', 'scan3.png']: # multi-page docs should be split into 1 file per page
        main(file)